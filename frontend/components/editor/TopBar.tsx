...
export default function TopBar() {
  return (
    <header className="h-16 border-b border-border-gray bg-bg-black flex items-center px-6 justify-between shrink-0 z-20">
      ...
      <div className="flex items-center gap-3">
        {/* Small Logo Icon (Optional if you want it next to text) */}
  ...
  group
  hover:text-white
  hover:border-electric-red/60
  hover:shadow-[0_0_18px_rgba(255,46,77,0.35)]
">
  ...
  <span className="tracking-wide">Preview</span>
        ...
        {/* Export Button */}
        <button className="flex items-center gap-2 px-5 py-2 bg-electric-red hover:bg-electric-red-hover text-white text-[11px] font-bold uppercase tracking-wider rounded transition-all shadow-[0_4px_14px_rgba(255,46,77,0.3)] hover:shadow-[0_6px_20px_rgba(255,46,77,0.4)] hover:-translate-y-0.5 active:translate-y-0">
